    ...
    <Row>
      <Col md="8">
        <h2 data-cy="categoryDetailsHeading">
          <Translate contentKey="cyrineshopApp.category.detail.title">Category</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="description">
              <Translate contentKey="cyrineshopApp.category.description">Description</Translate>
            </span>
          </dt>
          <dd>{categoryEntity.description}</dd>
          <dt>
            <span id="sortOrder">
              <Translate contentKey="cyrineshopApp.category.sortOrder">Sort Order</Translate>
            </span>
          </dt>
          <dd>{categoryEntity.sortOrder}</dd>
          <dt>
            <span id="dateAdded">
              <Translate contentKey="cyrineshopApp.category.dateAdded">Date Added</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="dateModified">
              <Translate contentKey="cyrineshopApp.category.dateModified">Date Modified</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="status">
              <Translate contentKey="cyrineshopApp.category.status">Status</Translate>
            </span>
          </dt>
          <dd>{categoryEntity.status}</dd>
          <dt>
            <Translate contentKey="cyrineshopApp.category.parent">Parent</Translate>
          </dt>
          <dd>{categoryEntity.parent ? categoryEntity.parent.id : ''}</dd>
          <dt>
            <Translate contentKey="cyrineshopApp.category.product">Product</Translate>
          </dt>
          <dd>
