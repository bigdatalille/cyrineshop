  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="cyrineshopApp.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
            <Translate contentKey="cyrineshopApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('cyrineshopApp.category.description')}
              ...
              />
              <ValidatedField
                label={translate('cyrineshopApp.category.sortOrder')}
              ...
              />
              <ValidatedField
                label={translate('cyrineshopApp.category.dateAdded')}
              ...
              />
              <ValidatedField
                label={translate('cyrineshopApp.category.dateModified')}
              ...
              />
              <ValidatedField
                label={translate('cyrineshopApp.category.status')}
                id="category-status"
                name="status"
                data-cy="status"
                type="select"
              >
                {categoryStatusValues.map(categoryStatus => (
                  <option value={categoryStatus} key={categoryStatus}>
                    {translate('cyrineshopApp.CategoryStatus.' + categoryStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="parent"
                data-cy="parent"
                label={translate('cyrineshopApp.category.parent')}
                type="select"
              >
                <option value="" key="0" />
                {categories
              ...
              <ValidatedField
                label={translate('cyrineshopApp.category.product')}
                id="category-product"
                data-cy="product"
                type="select"
                multiple
