...
describe('Product e2e test', () => {
  ...
  const productSample = { title: 'Rupee' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      ...
      cy.get(`[data-cy="keywords"]`).type('Franche-Comté Personal').should('have.value', 'Franche-Comté Personal');

      cy.get(`[data-cy="description"]`).type('transition b monitor').should('have.value', 'transition b monitor');

      cy.get(`[data-cy="rating"]`).type('47888').should('have.value', '47888');

      cy.get(`[data-cy="dateAdded"]`).type('2023-02-14').blur().should('have.value', '2023-02-14');

      cy.get(`[data-cy="dateModified"]`).type('2023-02-14').blur().should('have.value', '2023-02-14');
