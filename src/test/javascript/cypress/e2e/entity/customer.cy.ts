...
describe('Customer e2e test', () => {
  ...
  describe('new Customer page', () => {
    ...
    it('should create an instance of Customer', () => {
      cy.get(`[data-cy="firstName"]`).type('Aliénor').should('have.value', 'Aliénor');

      cy.get(`[data-cy="lastName"]`).type('Julien').should('have.value', 'Julien');

      cy.get(`[data-cy="email"]`).type('dith20@gmail.com').should('have.value', 'dith20@gmail.com');

      cy.get(`[data-cy="telephone"]`).type('+33 536111973').should('have.value', '+33 536111973');
